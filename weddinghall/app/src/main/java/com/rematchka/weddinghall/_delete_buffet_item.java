...
public class _delete_buffet_item extends AppCompatActivity implements AdapterView.OnItemSelectedListener  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__delete_buffet_item);
        type="get";
    ...
    private class JSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog=new AlertDialog.Builder(_delete_buffet_item.this).create();
            alertDialog.setTitle("Deleting Data");
            pDialog = new ProgressDialog(_delete_buffet_item.this);
        ...
        protected String doInBackground(String... args) {
            ...
            if (type.equals("get")) {
                ...
                String login_URL = "http://2f179dfb.ngrok.io/delete_buffet_item.php";
        ...
        protected void onPostExecute(String r) {
            ...
            if(!type.equals("get")) {
                if (result.equals(" deleted buffet item successfully"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(_delete_buffet_item.this,buffet_option.class);
                            _delete_buffet_item.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
