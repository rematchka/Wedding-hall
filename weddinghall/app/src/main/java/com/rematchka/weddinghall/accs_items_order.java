...
public class accs_items_order extends AppCompatActivity {
    ...
    private class JSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog=new AlertDialog.Builder(accs_items_order.this).create();
            alertDialog.setTitle("Upadting Data");
            pDialog = new ProgressDialog(accs_items_order.this);
        ...
        protected String doInBackground(String... args) {
            ...
            else
            {
                ...
                String login_URL = "http://2f179dfb.ngrok.io/insertaccsitem.php";
                ...
                try {
                    ...
                    { accsitems s=itemsAdapter.getItem(i);
                        ...
                        {   HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
                            ...
                            String post_data= URLEncoder.encode("user_name","UTF-8")+"="+URLEncoder.encode(user_name,"UTF-8")+"&"+URLEncoder.encode("accstid","UTF-8")+"="+URLEncoder.encode(s.getAcsID(),"UTF-8")+"&"+URLEncoder.encode("ord_id","UTF-8")+"="+URLEncoder.encode(ord_id,"UTF-8");
            ...
            if(!type.equals("get")) {
                if (result.equals("successful"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(accs_items_order.this,decor_order_item.class);
                            accs_items_order.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
