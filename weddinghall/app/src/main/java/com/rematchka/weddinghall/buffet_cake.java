...
public class buffet_cake extends AppCompatActivity {
    ...
    private class JSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog=new AlertDialog.Builder(buffet_cake.this).create();
            alertDialog.setTitle("Upadting Data");
            pDialog = new ProgressDialog(buffet_cake.this);
            ...
            if(!type.equals("get")) {
                if (result.equals("successful"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(buffet_cake.this,choose_buffet_items.class);
                            buffet_cake.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
