...
public class buffet_lunch extends AppCompatActivity {
    ...
    private class JSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog=new AlertDialog.Builder(buffet_lunch.this).create();
            alertDialog.setTitle("Upadting Data");
            pDialog = new ProgressDialog(buffet_lunch.this);
            ...
            if(!type.equals("get")) {
                if (result.equals("successful"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(buffet_lunch.this,choose_buffet_items.class);
                            buffet_lunch.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
