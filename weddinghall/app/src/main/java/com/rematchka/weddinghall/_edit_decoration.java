...
public class _edit_decoration extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__edit_decoration);
    ...
    private class JSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog=new AlertDialog.Builder(_edit_decoration.this).create();
        ...
        protected String doInBackground(String... args) {
            ...
            if (type.equals("get")) {
                String login_URL = "http://2f179dfb.ngrok.io/get_all_decor_items.php";
                try {
                    ...
                    for (int i = 0; i < result1.length(); i++) {
                        ...
                        fname = c.getString("decName");
                        price = c.getString("decPrice");
                        id32=c.getString("decID");

                        int id = Integer.parseInt(id32);
                        map.put(" Name " + fname + " price " + price, id);
                        categories.add(" Name " + fname + " price " + price);
                ...
                String login_URL = "http://2f179dfb.ngrok.io/update_decor_items.php";
        ...
        protected void onPostExecute(String r) {
            ...
            if(!type.equals("get")) {
                if (result.equals(" Editted decoration item successfully"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(_edit_decoration.this,decor_option.class);
                            _edit_decoration.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
