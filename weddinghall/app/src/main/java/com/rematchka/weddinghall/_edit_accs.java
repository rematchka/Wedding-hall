...
public class _edit_accs extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity__edit_accs);
    ...
    private class JSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog=new AlertDialog.Builder(_edit_accs.this).create();
        ...
        protected String doInBackground(String... args) {
            ...
            if (type.equals("get")) {
                String login_URL = "http://2f179dfb.ngrok.io/get_all_accs.php";
                try {
                    ...
                    for (int i = 0; i < result1.length(); i++) {
                        ...
                        fname = c.getString("acsName");
                        price = c.getString("acsPrice");
                        id32=c.getString("acsID");
                ...
                String login_URL = "http://2f179dfb.ngrok.io/update_accs_items.php";
        ...
        protected void onPostExecute(String r) {
            ...
            if(!type.equals("get")) {
                if (result.equals(" Editted accessories item successfully"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(_edit_accs.this,accs_option.class);
                            _edit_accs.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
