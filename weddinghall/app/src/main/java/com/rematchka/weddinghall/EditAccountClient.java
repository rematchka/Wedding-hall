...
public class EditAccountClient extends AppCompatActivity {
    EditText f_name;
    EditText M_name;
    EditText L_name;
    EditText phone_no;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        private class JSONParse extends AsyncTask<String, String, JSONObject> {
            ...
            protected void onPreExecute() {
                super.onPreExecute();
                alertDialog=new AlertDialog.Builder(EditAccountClient.this).create();
                alertDialog.setTitle("Upadting Data");
                pDialog = new ProgressDialog(EditAccountClient.this);
            ...
            protected JSONObject doInBackground(String... args) {
                ...
                if (t.equals("get")) {
                    ...
                    try {
                        ...
                        sharedPreferences = EditAccountClient.this.getSharedPreferences(userinfo.SHARED_PREF_NAME, Context.MODE_PRIVATE);
                        SharedPreferences sharedPreferences1;
                        sharedPreferences1 = EditAccountClient.this.getSharedPreferences(userinfo.SHARED_PREF_NAME, Context.MODE_PRIVATE);
                        ...
                        SharedPreferences sharedPreferences2 = EditAccountClient.this.getSharedPreferences(userinfo.SHARED_PREF_NAME, Context.MODE_PRIVATE);
                        ...
                        SharedPreferences sharedPreferences3 = EditAccountClient.this.getSharedPreferences(userinfo.SHARED_PREF_NAME, Context.MODE_PRIVATE);
            ...
            protected void onPostExecute(JSONObject json) {
                ...
                { if(result.equals(" sign up succsseful !!! hello"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(EditAccountClient.this,_log_in_menu_user.class);
                            EditAccountClient.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
