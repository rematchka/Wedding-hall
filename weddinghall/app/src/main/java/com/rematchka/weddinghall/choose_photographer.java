...
public class choose_photographer extends AppCompatActivity {
    ...
    private class JSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog=new AlertDialog.Builder(choose_photographer.this).create();
            alertDialog.setTitle("Upadting Data");
            pDialog = new ProgressDialog(choose_photographer.this);
        ...
        protected String doInBackground(String... args) {
            ...
            if (type.equals("get")) {
                ...
                String login_URL = "http://2f179dfb.ngrok.io/pckg_order.php";
                   ...
                   for(int i=0;i<itemsAdapter.getCount();i++)
                    { photographer s=itemsAdapter.getItem(i);
                        ...
                        {   HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
                            ...
                            String post_data= URLEncoder.encode("user_name","UTF-8")+"="+URLEncoder.encode(user_name,"UTF-8")+"&"+URLEncoder.encode("ordid","UTF-8")+"="+URLEncoder.encode(ordid,"UTF-8")+"&"+URLEncoder.encode("pkg_id","UTF-8")+"="+URLEncoder.encode(s.getPckg_id(),"UTF-8")+"&"+URLEncoder.encode("photo_id","UTF-8")+"="+URLEncoder.encode(s.getPhotog_id(),"UTF-8");
            ...
            if(!type.equals("get")) {
                if (result.equals("successful"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(choose_photographer.this,choose_buffet_items.class);
                           choose_photographer.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
