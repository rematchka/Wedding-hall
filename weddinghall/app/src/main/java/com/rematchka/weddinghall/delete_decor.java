...
public class delete_decor extends AppCompatActivity {
    ...
    private class JSONParse extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            alertDialog=new AlertDialog.Builder(delete_decor.this).create();
            alertDialog.setTitle("Deleting");
            pDialog = new ProgressDialog(delete_decor.this);
        ...
        protected String doInBackground(String... args) {
            ...
            else
            {
                ...
                String login_URL = "http://2f179dfb.ngrok.io/deletedecor.php";
                ...
                try {
                    ...
                    { decoritems s=itemsAdapter.getItem(i);
                        ...
                        {   HttpURLConnection httpURLConnection = (HttpURLConnection) url.openConnection();
                            ...
                            String post_data= URLEncoder.encode("decorid","UTF-8")+"="+URLEncoder.encode(s.getDecorID(),"UTF-8");
        ...
        protected void onPostExecute(String r) {
            ...
            if(!type.equals("get")) {
                if (result.equals(" deleted decoration item successfully"))
                {
                    new Handler().postDelayed(new Runnable() {
                        @Override
                        public void run() {
                            Intent logointent= new Intent(delete_decor.this,decor_option.class);
                            delete_decor.this.startActivity(logointent);
                        }
                    },SPLASH_TIME_OUT);
